...
This application is already in the [Google Play store](https://play.google.com/store/apps/details?id=fi.tv7.taivastv7). There are some screenshots of the application.
